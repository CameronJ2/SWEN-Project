...
class Player:
    def __init__(self, x, y, width, height, scale=2):
        ...
        # Load sprite sheets
        self.idle_sheet = pg.image.load('Refactored/img/Owl_Mon/Owlet_Monster_Idle_4.png').convert_alpha()
        self.running_sheet = pg.image.load('Refactored/img/Owl_Mon/Owlet_Monster_Run_6.png').convert_alpha()
        self.jumping_sheet = pg.image.load('Refactored/img/Owl_Mon/Owlet_Monster_Jump_8.png').convert_alpha()
